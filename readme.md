...
Esta pagina permite al usuario realizar reservas recurrentes para un mes y servicio escogido. En esta página se escoge el servicio, el mes, el año, el número de semanas que se desea reservar en ese mes y el dia de la semana.
